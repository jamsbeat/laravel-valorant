    ...
    <body class="flex items-center justify-center h-screen bg-valred">
        <div class="flex items-center justify-center w-full h-full py-12 z-50">
            <div class="w-full max-w-sm p-6 bg-white rounded-2xl shadow-lg">
                <h2 class="text-2xl font-bold text-valred w-full mb-6 font-suse">Login</h2>
                <form method="POST" action="/login">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <a href="#" class="text-sm text-valred font-sans hover:underline">Forgot password?</a>
                    </div>
                ...
                <p class="mt-8 text-center text-sm ">
                    Not a member? <a href="/register" class="text-valred font-semibold hover:underline">Register now!</a>
                </p>
            </div>
        </div>
    </body>
