<x-layout>
    ...
    <div class="flex justify-center">
        <div class="grid grid-cols-2 gap-y-6 gap-x-6 max-w-[870px] pt-16 ">
            @foreach ($agents as $agent)
            <li class="list-none">
                <a  href="/agents/{{ $agent['id'] }}">
                    <body class="flex items-center justify-center">
                        <div class="flex items-center w-full min-w-[415px] max-w-[415px] rounded-full bg-gray-800 transition-all duration-200 hover:scale-105 hover:shadow-lg" style="background-image: url(/images/playcard-bg.png)">
                            <img src="{{ $agent->icon }}" alt="Gekko" class="h-20 w-20 border-2 border-darkblue rounded-full" />
                            ...
                            <div class="ml-auto flex justify-end">
                                <div class="flex h-20 w-20 rounded-full ">
                                    <img src="{{ $agent->role_icon }}" alt="Icon" class="h-20 w-20 border-black border-2 rounded-full" />
                                </div>
                            </div>
                        </div>
                    </body> 
