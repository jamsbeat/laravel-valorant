<x-layout>
    ...
    <div class="py-12">
        <div>
            <div class="bg-white/50 p-4 font-montserrat text-md font-semibold rounded border border-black/10">
                Welcome to your profile page, <strong>{{ auth()->user()->first_name }}!</strong> Here you can view your favorite agents and update your profile settings.
            </div>
        </div>
    </div>
                ...
                @foreach(auth()->user()->favoriteAgents as $agent)
                    <div class="list-none">
                        <a href="/agents/{{ $agent['id'] }}">
                            <div class="flex items-center w-full lg:min-w-5xl min-w-4xl md:max-w-3xl lg:max-w-full rounded-full bg-gray-800 transition-transform duration-300 hover:scale-105 hover:shadow-lg" style="background-image: url(/images/playcard-bg.png)">
