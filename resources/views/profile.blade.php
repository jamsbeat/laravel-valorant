<x-layout>
    ...
    <div class="py-12">
        <div>
            <div class="bg-white/50 p-4 font-montserrat text-valblack text-md font-semibold rounded-3xl border border-black/10">
                        ...
                        <a href="/agents/{{ $agent->name }}">
                            <div class="flex items-center w-full min-w-4xl rounded-full bg-gray-800 transition-transform duration-300 hover:scale-105 hover:shadow-lg" style="background-image: url(/images/playcard-bg.png)">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                        <div class="text-2xl font-bold font-suse uppercase" style="color: {{ $agent->color }};">
                                        {{ $agent['name'] }}
                                    </div>
